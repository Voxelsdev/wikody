  ...
  (function makeModals() {
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      for (let j = 1; j <= 6; j++) {
        ...
        const $checkAnswer = $(`<a class="modal-action modal-close waves-effect waves-light btn forfeit #004d40 teal darken-4">\u2705</a>`);
        const $forfeitCol = $(`<div class="col s3">`);
        const $forfeitButton = $(`<a class="waves-effect waves-light btn forfeit #880e4f pink darken-4">\u2049</a>`);
